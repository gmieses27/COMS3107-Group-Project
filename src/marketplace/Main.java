...
public class Main {
    ...
    private static void averagePriceByCourse() {
        ...
        System.out.println("---------------------------------");
        List<CourseSummary> summaries = service.averagePriceByCourse();
    ...
    private static void studentVsMarketComparison() {
        ...
        System.out.println("-------------------------------------");
        List<MarketComparison> comps = service.studentVsMarketComparison();
        if (comps.isEmpty()) {
            System.out.println("No listings available.");
            return;
        }
    ...
    private static void marketFairnessScore() {
        ...
        System.out.println("-------------------------");
        FairnessResult res = service.marketFairnessScore();
    ...
    private static void demandIndex() {
        ...
        System.out.println("--------------------------------------------");
        List<DemandEntry> top = service.demandIndex(10);
        if (top.isEmpty()) {
            System.out.println("No listings available.");
            return;
        }
